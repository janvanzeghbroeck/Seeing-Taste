...
#### Second Project
Working with New Belgium further as a consultant, I oversaw and managed a follow up capstone project working on a off-flavor probability distribution prediction analysis. Check Jason Olson's Project [here](https://github.com/Jason-Olson/Scoring-Beer-For-New-Belgium).
